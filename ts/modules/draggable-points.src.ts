 ...
 */
function mouseDown(e: Event, chart: Highcharts.Chart): void {
...
function addDragDropEvents(chart: Highcharts.Chart): void {
    ...
    if (isChartDraggable(chart)) {
        addEvents(container, ['mousedown', 'touchstart'], function (
            e: Highcharts.PointerEventObject
        ): void {
            mouseDown(getNormalizedEvent(e, chart), chart);
        });
        addEvents(container, ['mousemove', 'touchmove'], function (
            e: Highcharts.PointerEventObject
        ): void {
